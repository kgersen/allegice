...
**(****see history below for full changes****)**

**SOFTWARE LICENSE AGREEMENT**  
  
LICENSE:  
  
\* Allegiance Game Manager is freeware.   
  
\* You may distribute your map made with Allegiance Game Manager as you want.  
  
\* You may not alter this software in any way, including changing help and text files.   
  
\* ALLEGIANCE GAME MANAGER IS DISTRIBUTED "AS IS". NO WARRANTY OF ANY KIND IS EXPRESSED OR IMPLIED. YOU USE IT AT YOUR OWN RISK. THE AUTHOR WILL NOT BE LIABLE FOR DATA LOSS, DAMAGES, LOSS OF PROFITS OR ANY OTHER KIND OF LOSS WHILE USING OR MISUSING THIS SOFTWARE.  
  
\* You are hereby licensed to make any number of backup copies of this free software and documentation. You can give the copy of the software to anyone or distribute the freeware version of the software providing that no additional fee is charged and the package files are not modified in any way.  
  
\* All copyrights to Allegiance Game Manager are exclusively  owned by Kirth Gersen   
  
\* Installing and using Allegiance Game Manager the acceptance of these terms and conditions of the license. If you do not agree with the terms of this license you must remove Allegiance Game Manager files from your storage devices and cease to use the product.  
...
And to the many beta-testers of the closed betas.

**A. Installation**

**You need to run AME on a computer where Allegiance is installed**

Nothing else to install. Just launch "AME.EXE"
...
*   display 'sector infos' (# he3 rocks (total he3/max he3), # of diff rocks)
